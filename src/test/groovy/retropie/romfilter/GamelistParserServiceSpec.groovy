...
/**
 * TODO: Write unit tests for XmlParserServiceSpec.
 * See the API for {@link grails.test.mixin.services.ServiceUnitTestMixin} for usage instructions
 */
@TestFor(GamelistParserService)
class GamelistParserServiceSpec extends Specification {
    ...
    void "test xml parsing"() {
        setup:
        String gamelistXml = resourceServiceActual.loadResource('/XmlParser/gamelist-sample.xml')
        ...
        game1.image == './downloaded_images/20 em 1 (Brazil)-image.jpg'
        ...
        game2.image == './downloaded_images/Ace of Aces (Europe)-image.jpg'
